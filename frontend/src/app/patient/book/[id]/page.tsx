...
const mockDoctor = {
    ...
    consultationFee: 800,
    availableSlots: [
        { date: '2026-01-15', time: '16:00', display: 'Today, 4:00 PM' },
        { date: '2026-01-15', time: '17:30', display: 'Today, 5:30 PM' },
        { date: '2026-01-16', time: '10:00', display: 'Tomorrow, 10:00 AM' },
        { date: '2026-01-16', time: '11:30', display: 'Tomorrow, 11:30 AM' },
        { date: '2026-01-16', time: '14:00', display: 'Tomorrow, 2:00 PM' },
    ]
}
...
export default function BookAppointmentPage() {
    ...
    const [selectedSlot, setSelectedSlot] = useState<typeof mockDoctor.availableSlots[0] | null>(null)
    ...
    return (
        <div className="max-w-4xl mx-auto">
            ...
            <div className="mb-8">
                ...
                <p className="text-slate-500 mt-1">with {doctor.name}</p>
            </div>
                        ...
                        >
                            ...
                            <div className="space-y-4 mb-6">
                                ...
                                <div className="flex justify-between items-center p-4 bg-slate-50 rounded-xl">
                                    ...
                                    <span className="font-bold text-lg text-primary-600">₹{doctor.consultationFee}</span>
                                </div>
                            </div>
                ...
                <div className="p-6 border-t border-slate-100 flex justify-between">
                    ...
                    {step < 5 ? (
                        ...
                        <button
                            ...
                            disabled={!consents.accuracy || !consents.aiAnalysis || !consents.cancellation}
                            className="flex items-center gap-2 px-8 py-3 bg-gradient-to-r from-primary-600 to-teal-500 text-white font-bold rounded-xl shadow-lg shadow-primary-500/30 hover:shadow-xl transition-all disabled:opacity-50 disabled:cursor-not-allowed"
                        >
