            ...
            <div className="relative z-10 w-full max-w-[440px] bg-white p-10 shadow-2xl rounded-none sm:rounded-lg">
                ...
                <div className="mt-8 pt-6 border-t border-slate-100 text-center">
                    <button
                        ...
                        className="w-full flex items-center justify-center gap-2 p-2 border border-slate-300 rounded hover:bg-slate-50 transition-colors text-slate-600 text-sm font-medium"
                    >
