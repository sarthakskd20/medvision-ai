                        ...
                        <AnimatePresence mode="wait">
                            ...
                            {step === 4 && (
                                ...
                                >
                                    ...
                                    <p className="text-slate-500 dark:text-slate-400 mb-6">Upload any relevant reports, scans, or prescriptions (PDF only, max 50MB total)</p>
                                    ...
                                    <label className="block border-2 border-dashed border-slate-300 dark:border-slate-600 rounded-2xl p-8 text-center cursor-pointer hover:border-primary-400 dark:hover:border-primary-500 hover:bg-primary-50/50 dark:hover:bg-primary-900/20 transition-all bg-white dark:bg-slate-700">
                                        ...
                                        <p className="text-sm text-slate-500 dark:text-slate-400 mt-1">PDF files only, up to 10 files</p>
                                    </label>
                                            ...
                                            {documents.map((doc) => (
                                                <div key={doc.id} className="bg-slate-50 dark:bg-slate-700/50 rounded-xl p-4">
                                                    <div className="flex items-start justify-between mb-3">
                                                        <div className="flex items-center gap-3">
                                                            ...
                                                            <div>
                                                                ...
                                                                <p className="text-xs text-slate-500 dark:text-slate-400">{(doc.file.size / 1024).toFixed(1)} KB</p>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div className="grid md:grid-cols-2 gap-4">
                                                        ...
                                                        <div>
                                                            <label className="block text-xs font-medium text-slate-600 dark:text-slate-400 mb-1">Upload Date</label>
                                                            <div className="px-3 py-2 text-sm bg-slate-100 dark:bg-slate-600 border border-slate-200 dark:border-slate-500 rounded-lg text-slate-600 dark:text-slate-300">
